...
class ROIService:
    ...
    def _getRegionFromCenter(self, centerPoint, size):
        ...
        ltx, lty = centerPoint[0] - width, centerPoint[1] + height
        rtx, rty = centerPoint[0] + width, centerPoint[1] + height
        rbx, rby = centerPoint[0] + width, centerPoint[1] - height
        lbx, lby = centerPoint[0] - width, centerPoint[1] - height
        ...
        pts.append((ltx, lty))  # 左上角
        pts.append((rtx, rty))  # 右上角
        pts.append((rbx, rby))  # 右下角
        pts.append((lbx, lby))  # 左下角
        return pts
